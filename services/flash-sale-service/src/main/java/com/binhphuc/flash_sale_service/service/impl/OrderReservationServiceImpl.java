...
public class OrderReservationServiceImpl implements OrderReservationService {
    ...
    @Override
    public void reserve(FlashSaleCreateOrderEvent event) {
    ...
    @Override
    public void release(FlashSaleCreateOrderEvent event) {
        List<FlashSaleOrderItem> items = event.getItems();
    ...
    private void publishSoldOutItems(FlashSaleCreateOrderEvent event, List<Long> result) {
        List<FlashSaleOrderItem> items = event.getItems();
        for (int i = 0; i < items.size(); i++) {
